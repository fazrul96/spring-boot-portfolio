...
import com.example.demo.model.ExperienceItem;
...
public class ExperienceServiceImpl implements ExperienceService {
        ...
        private List<ExperienceItem> createItemsForAccenture() {
                ...
                items.add(new ExperienceItem("Telco Plan Development",
                                "Involved in the development and implementation of telco plans..."));
                items.add(new ExperienceItem("Customer Portal Development",
                                "Proficient in creating intuitive and user-friendly customer portals..."));
                items.add(new ExperienceItem("Plan Purchasing and Modification",
                                "Knowledgeable in implementing features that allow customers to select..."));
